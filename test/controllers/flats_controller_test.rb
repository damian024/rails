...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference('Flat.count') do
      post flats_url, params: { flat: { description: @flat.description, price: @flat.price, rooms: @flat.rooms, size: @flat.size } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { description: @flat.description, price: @flat.price, rooms: @flat.rooms, size: @flat.size } }
